...
urlpatterns = patterns('forum.views',
    ...
    url(r'^topic/(?P<topic_id>\d+)/lock/$',              'update_topic_lock', {'locked': True},  name='forum_lock_topic'),
    url(r'^topic/(?P<topic_id>\d+)/unlock/$',            'update_topic_lock', {'locked': False}, name='forum_unlock_topic'),
    url(r'^topic/(?P<topic_id>\d+)/pin/$',               'update_topic_pin',  {'pinned': True},  name='forum_pin_topic'),
    url(r'^topic/(?P<topic_id>\d+)/unpin/$',             'update_topic_pin',  {'pinned': False}, name='forum_unpin_topic'),
    url(r'^topic/(?P<topic_id>\d+)/hide/$',              'update_topic_hide', {'hidden': True},  name='forum_hide_topic'),
    url(r'^topic/(?P<topic_id>\d+)/unhide/$',            'update_topic_hide', {'hidden': False}, name='forum_unhide_topic'),
